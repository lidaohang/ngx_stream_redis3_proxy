...
std::string StringUtil::TrimString(const std::string& s)
{
...
void StringUtil::SundaySearch(const std::string &text, const std::string &key, std::vector<size_t> &posVec, bool caseSensitive) {
...
void StringUtil::SundaySearch(const char *text, const char *key, std::vector<size_t> &posVec) {
    size_t textSize = strlen(text);
    size_t keySize = strlen(key);
    SundaySearch(text, textSize, key, keySize, posVec);
}

void StringUtil::SundaySearch(const char *text, size_t textSize, const char *key, size_t keySize, std::vector<size_t> &posVec) {
    posVec.clear();
...
void StringUtil::ReplaceLast(std::string &str, const std::string& oldStr,
...
void StringUtil::ReplaceAll(std::string& str, const std::string& oldStr,
                            const std::string& newStr) {
